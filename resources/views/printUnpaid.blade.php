...
<body>
    <button onclick="sendPrintCommand()" class="no-print">ปริ้นผ่าน Application</button>
    <button onclick="window.print()" class="no-print">ปริ้นแบบธรรมดา</button>
    ...
    <script>
        ...
        function renderReceiptPreview() {
            ...
            html += `<div style='margin-top:8px;'><b>เลขโต๊ะ:</b> ${data.id || ''}</div>`;
            html += `<div style='margin-top:8px;'><b>วันที่:</b> ${data.date || ''}</div>`;
            if (data.tax_full) {
